...
public class EngineerAdapter extends BaseAdapter {
    ...
    public EngineerAdapter(Context context, ArrayList<String> list) {
        this.mList = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = View.inflate(mContext, R.layout.item_listengineer, null);
    ...
    static class ViewHolder {
        ...
        public ViewHolder(View view) {
            txt = (TextView) view.findViewById(R.id.tv_engineer);
        }
    }
}