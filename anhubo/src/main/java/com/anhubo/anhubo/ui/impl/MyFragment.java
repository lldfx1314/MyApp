...
public class MyFragment extends BaseFragment {
    ...
    private LinearLayout llUseGuide;
...
//        tv_basepager_title.setText("我的界面");
    ...
    public void initView() {
        ...
        llUseGuide = findView(R.id.ll_useGuide);
        llFeedback = findView(R.id.ll_feedback);
    ...
    public void initListener() {
        ...
        llUseGuide.setOnClickListener(this);
    ...
    private void setData(String response) {
        ...
        if (bean != null) {
            ...
            // 这里重新保存一次是解决两个手机同时登陆一个账号时，一个把单位给变换了，另一个手机上也能同时改变
...
//        SpUtils.putParam(mActivity, AreaBindingActivity.DOT_MESSAGE, null);
        /**用户所在楼层*/
        SpUtils.putParam(mActivity, Keys.USERFLOOR, null);
        //跳转到登录页面
