...
public class MyRoundProcess extends View {
    ...
    private float mStrokeWidth = DisplayUtil.dp2px(getContext(),5);
    ...
    private void initAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            ...
            textColor = a.getColor(R.styleable.MyRoundProcess_textColor, getResources().getColor(R.color.bg_title));
//            textSize = a.getDimension(R.styleable.MyRoundProcess_textSize, 22f);
    ...
    public void runAnimate(float targetProgress) {
        ...
        mAnimator.setDuration((long) (targetProgress * 11));
        mAnimator.start();
    }
